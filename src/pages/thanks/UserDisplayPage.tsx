...
const UserDisplayPage: React.FC = () => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-8">
            ...
            {user ? (
                <div className="mt-[-15%] p-4  rounded-xl text-center max-w-xl w-full animate-fade-in z-10">
                   ...
                   <h3 className="text-3xl mt-10 dancing-script text-red-600 my-5">Chào mừng Đại biểu</h3>
                    {user.avatar && (
